//
//  ViewControllerCoreML.swift
//  DisplayLiveSamples
//
//  Created by Devi Prasasd Tripathy on 1/5/19.
...
class ViewControllerCoreML: UIViewController {
    ...
    public let sessionQueue = DispatchQueue(label: "session queue", attributes: [], target: nil) // Communicate with the session and other session objects on this queue.
    ...
    public var videoDataOutputQueue = DispatchQueue(label: "VideoDataOutputQueue")
...
extension ViewControllerCoreML: AVCaptureVideoDataOutputSampleBufferDelegate{
